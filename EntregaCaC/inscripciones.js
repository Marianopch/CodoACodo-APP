...
const expresiones = {
  equipo: /^[a-zA-ZÀ-ÿ\s]{1,40}$/, // Letras y espacios, pueden llevar acentos.
...
contacto.addEventListener('submit', (e) => {
  ...
  if (campos.nombre && campos.telefono && campos.correo && campos.equipo) {
    form.reset();
    ...
    campos['nombre', 'telefono', 'correo', 'equipo'] = false;
  } else {
